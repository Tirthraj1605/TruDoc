    ...
    <main className="home bg-cover bg-center bg-no-repeat bg-white px-10 dark:bg-green-100 md:px-20 lg:px-40">
      <section className="min-h-screen">
        ...
        <nav className="py-10 mb-12 flex justify-between dark:text-white">
          <div className=" h-60 w-60 block mt-4 lg:inline-block text-xl lg:mt-0 dark:text-black  font-bold italic hover:text-black px-4 py-2 rounded  mr-2 text-left fixed"><button onClick={() => { window.scrollTo({ top: 0, behavior: "smooth" }) }}>TD</button></div>
          <div className="text-md text-right font-bold text- lg:flex-grow">
            ...
            <div className="block mt-4 lg:inline-block lg:mt-0 hover:text-white px-4 py-2 rounded bg-blue-500 hover:bg-teal-600 mr-2"><button onClick={() => { window.scrollTo({ top: 5000, behavior: "smooth" }) }}>True Prescription</button></div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <div className="block mt-4 lg:inline-block lg:mt-0 hover:text-white px-4 py-2 rounded bg-blue-500 hover:bg-teal-600 mr-2"><button onClick={() => { window.scrollTo({ top: 850, behavior: "smooth" }) }}>About</button></div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <div className="bg-blue-100">
          ...
          <div className="bg-color-black text-ceter ">
